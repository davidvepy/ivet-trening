function renderProfile(){
  const content=`<header class="page-title"><h1>Profil</h1></header>
    <div class="profile-card"><div><span>Prihlásený účet</span><b>${h(state.user.email||'Ivet')}</b></div><button id="logout">Odhlásiť</button></div>
    ...
    <div class="help-list">
      ...
      <details><summary>Kedy pridať váhu</summary><p>Najprv dosiahni hornú hranicu opakovaní vo všetkých pracovných sériách. Potom pridaj najmenší dostupný krok záťaže.</p></details>
    ...
    <div class="app-info"><span>Ivet · Tréning v${APP_VERSION}</span><p>Dáta sú uložené v Supabase. Tréningy sú oddelené cez client_id = wife. Telesné merania sú v tejto verzii zámerne vypnuté, aby sa nemiešali s Dávidovými dátami.</p></div>`;
